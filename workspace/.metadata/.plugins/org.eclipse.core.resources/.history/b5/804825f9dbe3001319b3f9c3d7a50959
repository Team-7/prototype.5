...
public class MyConnect extends AsyncTask {
    ...
    {  
        ...
        try{   
                ...
                HttpPost httppost = new HttpPost("http://10.0.2.2/sync/get_child.php");  
    ...
    {  
        ...
        try{   
                ...
                HttpClient httpclient = new DefaultHttpClient();  
                HttpPost httppost = new HttpPost("http://10.0.2.2/sync/get_cw.php");  
        ...
        // </namevaluepair> </namevaluepair> 
         ...
         try{
             ...
             for(int i=0;i<jArray.length();i++){  
                 ...
                 if (mydb.insertCommunityWorker(json_data.getString("username"), json_data.getString("password"), json_data.getString("name"),json_data.getInt("centre_id"))> 0) 
                	 x = true;
             }
        	}
        catch (JSONException e){   
    ...
    try {  
        ...
        try{   
        		...
        		StringEntity se = new StringEntity(jsonarray.toString()); 
                HttpClient httpclient = new DefaultHttpClient();  
                HttpPost httppost = new HttpPost("http://10.0.2.2/sync/get_mychildBmi.php");  
                httppost.setEntity(se);  
                HttpResponse response = httpclient.execute(httppost);  
                HttpEntity entity = response.getEntity();  
                is = entity.getContent();  
      ...
      try {  
        ...
        try{   
               ...
               // ArrayList<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>();  
        	    StringEntity se = new StringEntity(jsonarray.toString()); 
                HttpClient httpclient = new DefaultHttpClient();  
                HttpPost httppost = new HttpPost("http://10.0.2.2/sync/get_mybmi.php");  
                httppost.setEntity(se);  
                HttpResponse response = httpclient.execute(httppost);  
                HttpEntity entity = response.getEntity();  
                is = entity.getContent();  
    ...
    {  
        ...
        try{   
                ...
                HttpClient httpclient = new DefaultHttpClient();  
                HttpPost httppost = new HttpPost("http://10.0.2.2/sync/get_cc.php");  
                httppost.setEntity(new UrlEncodedFormEntity(nameValuePairs));  
                HttpResponse response = httpclient.execute(httppost);  
                HttpEntity entity = response.getEntity();  
                is = entity.getContent();  
